...
const MentorDashboard = ({ students = [], currentMentor = 'Dr. Harshita Gour' }) => {
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {mentorStudents.map((student) => (
                      <tr key={student.Student_ID} className="hover:bg-gray-50">
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <div className="ml-4">
                              ...
                              <div className="text-sm text-gray-500">ID: {student.Roll_No}</div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-900">{student.Attendance_Percentage}%</td>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className={`h-2 rounded-full ${student.Attendance_Percentage >= 75 ? 'bg-green-600' : 'bg-red-600'}`}
                      ...
                      <div>
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-medium">{student.Avg_Test_Score}%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className={`h-2 rounded-full ${student.Avg_Test_Score >= 60 ? 'bg-green-600' : 'bg-red-600'}`}
                            style={{ width: `${student.Avg_Test_Score}%` }}
                          />
                        </div>
                      </div>
                      
                      <div className="text-xs text-gray-500">
                        Last intervention: {interventions.find(i => i.studentId === student.Student_ID)?.date.toLocaleDateString() || 'None'}
                      </div>
                    </div>
                  </div>
                ))}
