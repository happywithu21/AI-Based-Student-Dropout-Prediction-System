...
import { api } from './services/api_integrated';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-[98%] mx-auto px-3 sm:px-4 lg:px-8">
      ...
      {/* Main Content */}
      <main className="max-w-[98%] mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8 pb-20 md:pb-8">
        {currentView === 'dashboard' && (
          <>
            {students.length === 0 ? (
